...
students = {
    0: {
        "firstName": "Avery",
        "lastName": "Example",
        "email": "avery.example@student.example.test",
        "NSHEID": int("900001")
    },
    1: {
        "firstName": "Jordan",
        "lastName": "Sample",
        "email": "jordan.sample@student.example.test",
        "NSHEID": int("900002")
    },
    2: {
        "firstName": "Riley",
        "lastName": "Demo",
        "email": "riley.demo@student.example.test",
        "NSHEID": int("900003")
    },
    3: {
        "firstName": "Casey",
        "lastName": "Test",
        "email": "casey.test@student.example.test",
        "NSHEID": int("900004")
    },
}
...
faculty = {
    0: {
        "firstName": "Morgan",
        "lastName": "Example",
        "email": "morgan.example@faculty.example.test",
        "password": "FacultyDemo101"
    },
    1: {
        "firstName": "Taylor",
        "lastName": "Sample",
        "email": "taylor.sample@faculty.example.test",
        "password": "FacultyDemo202"
    },
}
...
def validateEmail(email):
    ...
    facultyEmail = "@faculty.example.test"
    atSign = email.find('@')
...
def addExams():
    def ensure_faculty_and_location(campus):
        faculty = Faculty.query.filter_by(lastName="Example").first()
        if not faculty:
            faculty = Faculty(
                firstName="Morgan",
                lastName="Example",
